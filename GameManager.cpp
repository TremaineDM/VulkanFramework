...
VKAPI_ATTR VkBool32 VKAPI_CALL GameManager::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
...
void GameManager::PopulateDebugUtilsMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
	createInfo = {};
...
void GameManager::PickPhysDevice()
{
...
bool GameManager::isDeviceSuitable(VkPhysicalDevice device)
{
...
QueueFamilyIndices GameManager::FindQueueFamilies(VkPhysicalDevice device)
{
...
void GameManager::CreateLogicalDevice()
{
...
void GameManager::CreateSurface()
{
...
bool GameManager::CheckDeviceExtensionSupport(VkPhysicalDevice device)
{
...
void GameManager::CreateImageViews()
{
...
SwapChainDetails GameManager::QuerySwapChainSupport(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR GameManager::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR GameManager::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D GameManager::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void GameManager::CreateGraphicsPipeline()
{
...
void GameManager::CreateRenderPass()
{
...
std::vector<char> GameManager::ReadFile(const std::string& filename)
{
...
VkShaderModule GameManager::CreateShaderModule(const std::vector<char>& code)
{
...
void GameManager::CreateFrameBuffers()
{
...
void GameManager::CreateCommandPool()
{
...
void GameManager::CreateCommandBuffers()
{
...
void GameManager::CreateSyncObjects()
{
...
void GameManager::RecreateSwapChain()
{
	int width = 0; 
	int height = 0;
	glfwGetFramebufferSize(window, &width, &height);
...
void GameManager::CleanupSwapChain()
{
...
void GameManager::CreateVertexBuffer()
{
...
uint32_t GameManager::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
void GameManager::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
void GameManager::CopyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void GameManager::CreateIndexBuffer()
{
...
void GameManager::CreateDescriptorSetLayout()
{
...
void GameManager::CreateDescriptorPool()
{
...
void GameManager::CreateDescriptorSets()
{
...
void GameManager::CreateUniformBuffers()
{
...
void GameManager::UpdateUniformBuffer(uint32_t currentImage)
{
...
void GameManager::CreateTextureImage()
{
...
void GameManager::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
							  VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
	...
	VkMemoryRequirements memReqs;
	vkGetImageMemoryRequirements(logicDevice, image, &memReqs);
...
void GameManager::CreateTextureImageView()
{
	textureImageView = CreateImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
}

void GameManager::CreateTextureSampler()
{
	...
	if (vkCreateSampler(logicDevice, &samplerInfo, nullptr, &textureSampler) != VK_SUCCESS)
	{
		throw std::runtime_error("failed to create texture sampler!");
	}
}

VkCommandBuffer GameManager::BeginSingleTimeCommands()
{
	VkCommandBufferAllocateInfo allocInfo{};
	allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
	allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void GameManager::EndSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void GameManager::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
	VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
void GameManager::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
VkImageView GameManager::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
...
void GameManager::CreateDepthResources()
{
...
VkFormat GameManager::FindSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
VkFormat GameManager::FindDepthFormat()
{
	return FindSupportedFormat({ VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT },
								 VK_IMAGE_TILING_OPTIMAL, VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT);
}

bool GameManager::hasStencilComponent(VkFormat format)
{
	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

void GameManager::LoadModel()
{
...
void GameManager::GenerateMipmaps(VkImage image, VkFormat format, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
...
void GameManager::Destroy()
{
	...
	vkDestroyImageView(logicDevice, textureImageView, nullptr);
	vkDestroyImage(logicDevice, textureImage, nullptr);
	vkFreeMemory(logicDevice, textureImageMemory, nullptr);
...
bool GameManager::CheckValidationLayerSupport()
{
	uint32_t layerCount;
...
std::vector<const char*> GameManager::GetRequiredExtensions()
{
...
void GameManager::SetupDebugMessenger()
{
	if (!enableValidationLayers)
	{
		return;
...
{
	auto app = reinterpret_cast<GameManager*>(glfwGetWindowUserPointer(window));
